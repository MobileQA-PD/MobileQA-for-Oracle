...
define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'mbe',
  ...
  function (oj, ko, $, app, mbe) {
    function DetailsViewModel () {
      ...
      self.cpuUsage = ko.observable('')
      self.memoryUsage = ko.observable('')
      ...
      self.handleActivated = function (info) {
        ...
        mbe.invokeCustomAPI(url, 'GET', null, function (statusCode, data) {
          ...
          if (data.items.length > 0) {
            ...
            self.cpuUsage(value.cpuUsage)
            self.memoryUsage(value.memoryUsage)
          }
        }, function (error) {
